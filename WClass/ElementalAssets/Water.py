import pygame
from WClass.ElementalAssets.Ground_Water import water_wave
...
class water(pygame.sprite.Sprite):
        ...
        if self.activated == False:
            ...
            if self.attack_type == 1:
                if self.rect.bottom + self.rect.y <= screen_height +310:
                    ...
                    self.set_water_wave()
                    self.projectiles.add(self.element_water_left)
                    self.projectiles.add(self.element_water_right)
    ...
    def set_water_wave(self):
        self.element_water_right = water_wave(self.direct, self.rect.x, self.rect.y + 30, self.target, self)
        self.element_water_left = water_wave(-self.direct, self.rect.x + 15, self.rect.y + 30, self.target, self)